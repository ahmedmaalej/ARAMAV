                        ...
                        % Last Modified by GUIDE v2.5 05-Feb-2014 10:19:15
...
%%%----------------  Deroulement du test -----------------------------
% --- Executes on button press in Lancer_test_pushbutton7.
function Lancer_test_pushbutton7_Callback(hObject, eventdata, handles)
...
% handles    structure with handles and user data (see GUIDATA)
                        handles = guidata(gcbo);
                        handles.background_color = uisetcolor;
                        Screen('FillRect', handles.wPtr, handles.background_color);
                        Screen('Flip', handles.wPtr);%% rafrechissement
                        guidata(hObject,handles);
